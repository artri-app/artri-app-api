...
from .views import LoginView, RemedyListCreateView, ExerciseListCreateView, TrainingListCreateView, TrainingReportListCreateView, DailyPainReportListCreateView
